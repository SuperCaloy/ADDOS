...
_PHASE_LABELS = {
    ...
    ("wave",    "syn"):     "SYN wave (5 SYN attackers)",
    ("wave",    "icmp"):    "ICMP wave (5 ICMP attackers)",
    ("wave",    "udp"):     "UDP wave (5 UDP attackers)",
    ("wave",    "mixed_a"): "mixed wave A (all 15, staged SYN/UDP/ICMP)",
    ("wave",    "mixed_b"): "mixed wave B (all 15, repeat offenders)",
